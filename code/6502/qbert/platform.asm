...
+byteTmsColorFgBg c3, PLATFORM_COLOR_BASE
+byteTmsColorFgBg c3, PLATFORM_COLOR_BASE
+byteTmsColorFgBg TMS_TRANSPARENT, PLATFORM_COLOR_BASE
+byteTmsColorFgBg TMS_TRANSPARENT, PLATFORM_COLOR_BASE
...
+byteTmsColorFgBg c1, c4
+byteTmsColorFgBg PLATFORM_COLOR_BASE, c4
+byteTmsColorFgBg PLATFORM_COLOR_BASE, c4
+byteTmsColorFgBg PLATFORM_COLOR_BASE, c3
+byteTmsColorFgBg PLATFORM_COLOR_BASE, TMS_TRANSPARENT
+byteTmsColorFgBg PLATFORM_COLOR_BASE, TMS_TRANSPARENT
}

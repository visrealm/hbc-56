...
LBB_BINS
	!text	"IN$(",TK_BINS	; BIN$(
LBB_BITCLR
	!text	"ITCLR",TK_BITCLR	; BITCLR
LBB_BITSET
	!text	"ITSET",TK_BITSET	; BITSET
LBB_BITTST
...
TAB_ASCD
LBB_DATA
	!text	"ATA",TK_DATA	; DATA
LBB_DEC
	!text	"EC",TK_DEC		; DEC
LBB_DEEK
	!text	"EEK(",TK_DEEK	; DEEK(
LBB_DEF
	!text	"EF",TK_DEF		; DEF
LBB_DIM
	!text	"IM",TK_DIM		; DIM
...
LBB_LCASES
	!text	"CASE$(",TK_LCASES
					; LCASE$(
LBB_LEFTS
	!text	"EFT$(",TK_LEFTS	; LEFT$(
LBB_LEN
	!text	"EN(",TK_LEN	; LEN(
LBB_LET
	!text	"ET",TK_LET		; LET
LBB_LIST
	!text	"IST",TK_LIST	; LIST
LBB_LOAD
	!text	"OAD",TK_LOAD	; LOAD
LBB_LOG
	!text	"OG(",TK_LOG	; LOG(
LBB_LOOP
...
LBB_REM
	!text	"EM",TK_REM		; REM
LBB_RESTORE
	!text	"ESTORE",TK_RESTORE
					; RESTORE
LBB_RETIRQ
	!text	"ETIRQ",TK_RETIRQ	; RETIRQ
LBB_RETNMI
	!text	"ETNMI",TK_RETNMI	; RETNMI
LBB_RETURN
	!text	"ETURN",TK_RETURN	; RETURN
LBB_RIGHTS
	!text	"IGHT$(",TK_RIGHTS
					; RIGHT$(
LBB_RND
...
LBB_SQR
	!text	"QR(",TK_SQR	; SQR(
LBB_STEP
	!text	"TEP",TK_STEP	; STEP
LBB_STOP
	!text	"TOP",TK_STOP	; STOP
LBB_STRS
	!text	"TR$(",TK_STRS	; STR$(
LBB_SWAP
